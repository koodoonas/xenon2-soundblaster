...
**Hardware report:** Tested [successfully]([url](https://www.youtube.com/watch?v=VaM9JKJuMTs)) on a real **386 with a PicoGUS in Sound Blaster mode**. Development testing also covered DOSBox with emulated SB16 and SB2 configurations. A full playthrough and original Creative ISA cards have not been verified.
